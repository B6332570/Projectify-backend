                    ...
                    if (!Array.isArray(itemChild2)) {
                      ...
                      for (const c3Item of itemChild2) {
                        ...
                        for (let [c3Index, c3Key] of Object.keys(
                          ...
                          const itemChild3 = c3Item[c3Key];
                          console.log(`🐛  • itemChild3:`, itemChild3);
                          if (!Array.isArray(itemChild3)) {
                            ws.cell(child3Row, c3Index + child3Index)
                              .string(`${itemChild3 || ''}`)
                              .style(dataStyle);
                            ...
                            let child4Index = child3Index + 1;
                            let child4Row = child3Row;
                            let new5Raw = child3Row;
                            for (const c4Item of itemChild3) {
                              let isChild4Count = true;
                              for (let [c4Index, c4Key] of Object.keys(
                                c4Item,
                              ).entries()) {
                                const itemChild4 = c4Item[c4Key];
                                if (!Array.isArray(itemChild4)) {
                                  ...
                                  Array.isArray(itemChild4) &&
                                  itemChild4.length > 0
                                ) {
                                  let child5Index = child4Index + 1;
                                  let child5Row = child4Row;
                                  for (const c5Item of itemChild4) {
                                    for (let [c5Index, c5Key] of Object.keys(
                                      c5Item,
                                    ).entries()) {
                                      const itemChild5 = c5Item[c5Key];
                                      if (!Array.isArray(itemChild5)) {
                                        ws.cell(
                                          child5Row,
                                          c5Index + child5Index,
                                        )
